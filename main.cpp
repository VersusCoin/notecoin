...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Versus-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.versus.network", "seed2.versus.network", "seed3.versus.network", ""};
static const string testnet_seeds[] = {"testnet-dns.versus.network", "testnet2-dns.versus.network", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("versus.network", 20204), true);
  }
  do {
